  ...
  return (
    <div className="task-pending-attachments">
      ...
      <p className="task-pending-attachments__hint">
        Enter a name and choose a file, then create the ticket (or click Add attachment to queue several files). Max 10MB each.
      </p>
...
export async function uploadPendingTaskAttachments({
  ...
  for (const item of items) {
    try {
      ...
      await axiosInstance.post(`/tickets/${taskId}/attachments/upload`, formData, {
